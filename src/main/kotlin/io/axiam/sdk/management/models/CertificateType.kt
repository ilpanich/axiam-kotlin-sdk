 ...
 * [CertificateType.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule
 ...
 */
@Serializable(with = CertificateType.Companion.Serializer::class)
enum class CertificateType(val wire: String) {
    USER("User"),
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<CertificateType> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.CertificateType", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: CertificateType) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): CertificateType {
