 ...
 * [PgpKeyPurpose.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule 1).
 ...
 */
@Serializable(with = PgpKeyPurpose.Companion.Serializer::class)
enum class PgpKeyPurpose(val wire: String) {
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<PgpKeyPurpose> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.PgpKeyPurpose", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: PgpKeyPurpose) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): PgpKeyPurpose {
