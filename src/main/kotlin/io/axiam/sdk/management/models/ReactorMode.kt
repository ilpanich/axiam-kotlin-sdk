 ...
 * [ReactorMode.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule 1).
 ...
 */
@Serializable(with = ReactorMode.Companion.Serializer::class)
enum class ReactorMode(val wire: String) {
    INTERCEPT("intercept"),
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<ReactorMode> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.ReactorMode", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: ReactorMode) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): ReactorMode {
