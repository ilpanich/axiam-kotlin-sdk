 ...
 * [PgpKeyAlgorithm.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule
 ...
 */
@Serializable(with = PgpKeyAlgorithm.Companion.Serializer::class)
enum class PgpKeyAlgorithm(val wire: String) {
    RSA4096("Rsa4096"),
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<PgpKeyAlgorithm> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.PgpKeyAlgorithm", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: PgpKeyAlgorithm) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): PgpKeyAlgorithm {
