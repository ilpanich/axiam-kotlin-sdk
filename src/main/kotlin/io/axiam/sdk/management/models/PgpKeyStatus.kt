 ...
 * [PgpKeyStatus.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule 1).
 ...
 */
@Serializable(with = PgpKeyStatus.Companion.Serializer::class)
enum class PgpKeyStatus(val wire: String) {
    ACTIVE("Active"),
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<PgpKeyStatus> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.PgpKeyStatus", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: PgpKeyStatus) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): PgpKeyStatus {
