 ...
 * [UserStatus.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule 1).
 ...
 */
@Serializable(with = UserStatus.Companion.Serializer::class)
enum class UserStatus(val wire: String) {
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<UserStatus> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.UserStatus", PrimitiveKind.STRING)
