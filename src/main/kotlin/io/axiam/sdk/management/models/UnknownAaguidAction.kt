 ...
 * [UnknownAaguidAction.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11
 ...
 */
@Serializable(with = UnknownAaguidAction.Companion.Serializer::class)
enum class UnknownAaguidAction(val wire: String) {
    ALLOW("allow"),
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<UnknownAaguidAction> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.UnknownAaguidAction", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: UnknownAaguidAction) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): UnknownAaguidAction {
