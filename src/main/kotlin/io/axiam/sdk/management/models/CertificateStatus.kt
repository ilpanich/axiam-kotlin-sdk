 ...
 * [CertificateStatus.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule
 ...
 */
@Serializable(with = CertificateStatus.Companion.Serializer::class)
enum class CertificateStatus(val wire: String) {
    ACTIVE("Active"),
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<CertificateStatus> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.CertificateStatus", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: CertificateStatus) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): CertificateStatus {
