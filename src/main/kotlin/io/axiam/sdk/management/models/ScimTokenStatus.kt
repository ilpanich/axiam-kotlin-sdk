 ...
 * [ScimTokenStatus.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule
 ...
 */
@Serializable(with = ScimTokenStatus.Companion.Serializer::class)
enum class ScimTokenStatus(val wire: String) {
    ACTIVE("active"),
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<ScimTokenStatus> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.ScimTokenStatus", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: ScimTokenStatus) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): ScimTokenStatus {
