 ...
 * [SettingsScope.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule 1).
 ...
 */
@Serializable(with = SettingsScope.Companion.Serializer::class)
enum class SettingsScope(val wire: String) {
    ORG("Org"),
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<SettingsScope> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.SettingsScope", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: SettingsScope) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): SettingsScope {
