 ...
 * [AuditOutcome.UNKNOWN] rather than failing the response it arrived in (CONTRACT §27.11 rule 1).
 ...
 */
@Serializable(with = AuditOutcome.Companion.Serializer::class)
enum class AuditOutcome(val wire: String) {
    SUCCESS("Success"),
    ...
    companion object {
         ...
         */
        internal object Serializer : KSerializer<AuditOutcome> {
            override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("io.axiam.sdk.management.models.AuditOutcome", PrimitiveKind.STRING)

            override fun serialize(encoder: Encoder, value: AuditOutcome) {
                encoder.encodeString(value.wire)
            }

            override fun deserialize(decoder: Decoder): AuditOutcome {
