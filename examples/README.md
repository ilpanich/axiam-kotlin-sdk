...
| OPAQUE login | [`opaque-login/OpaqueLoginExample.kt`](opaque-login/OpaqueLoginExample.kt) | The §23 OPAQUE (RFC 9807) exchange: `opaqueAvailable`, `loginOpaque`, the disabled-tenant fallback, and `opaqueEnrollment` |
